...
struct ExamplePGN: Hashable {
    ...
    static let list = [ExamplePGN(name: "Caro Kann Goldman Variation", userColor: .white, fileName: "exampleCaroKannGoldman", creator: "xJimmyCx on Lichess.com", url: "https://lichess.org/study/Rvu7G9VX"),
                       ExamplePGN(name: "Danish Gambit Refutation", userColor: .black, fileName: "exampleDanishRefutation", creator: "RebeccaHarris RIP on Lichess.com", url: "https://lichess.org/study/udExyu0p"),
                       ...
                       ExamplePGN(name: "Englund Gambit Refutation", userColor: .white, fileName: "exampleEnglundRefutation", creator: "RebeccaHarris RIP on Lichess.com", url: "https://lichess.org/study/inBWS4oN")].sorted(by: {$0.name < $1.name})
