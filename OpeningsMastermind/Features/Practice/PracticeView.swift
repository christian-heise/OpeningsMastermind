...
struct PracticeView: View {
    ...
    init(database: DataBase, vm: PracticeViewModel) {
        self.vm = vm
            ...
            GeometryReader { geo in
                ...
                .toolbar {
                    ToolbarItem(placement: .navigationBarLeading) {
                        ...
                        .accessibilityIdentifier("practice.reviewInExplorerButton")
                    }
                    ToolbarItem() {
                        Button() {
                            dismiss()
...
struct PracticeView_Previews: PreviewProvider {
    static var previews: some View {
        ...
        let appData = AppData()
        PracticeView(database: database, vm: PracticeViewModel(database: database, appData: appData))
            .environment(appData)
