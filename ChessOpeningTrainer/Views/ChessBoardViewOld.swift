...
struct ChessBoardViewOld_Previews: PreviewProvider {
    ...
    static var previews: some View {
        ChessBoardViewOld(game: .constant(Game(position: italianGamePosition)), gameTree: GameTree.example(), settings: Settings(), database: DataBase())
    }
}
